...
public class AdminController {
	...
	public String insert_member(EmployerInfoVO memberVO,RedirectAttributes rdat) throws Exception {
		...
		String encPassword = EgovFileScrty.encryptPassword(memberVO.getPASSWORD(), memberVO.getESNTL_ID());
		memberVO.setPASSWORD(encPassword);//egov암호화툴로 암호화된 값 set
		memberVO.setESNTL_ID("USRCNFRM_" + memberVO.getESNTL_ID());//고유 ID값 SET
