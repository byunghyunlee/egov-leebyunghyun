		...
		<div class="location_area customer">
			<div class="box_inner">
				...
				<ul class="page_menu clear">
					<li><a href="<c:url value='/tiles/board/list_board.do?bbsId=BBSMSTR_AAAAAAAAAAAA' />" class="<c:out value='${brdMstrVO.bbsId=="BBSMSTR_AAAAAAAAAAAA"?"on":""}' />">${brdMstrVO.bbsNm}공지사항</a></li>
